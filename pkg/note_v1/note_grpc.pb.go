...
const (
	NoteService_CreateNote_FullMethodName = "/api.node_v1.NoteService/CreateNote"
	NoteService_GetNote_FullMethodName    = "/api.node_v1.NoteService/GetNote"
	NoteService_UpdateNote_FullMethodName = "/api.node_v1.NoteService/UpdateNote"
	NoteService_DeleteNote_FullMethodName = "/api.node_v1.NoteService/DeleteNote"
)
